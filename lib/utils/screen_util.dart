...
class Constant{
  ...
  static double sizeXXXLL = 80.0;


  /*peddign & Margin in components*/
  static double sizebg_Big = 200.0;
  static double sizebg_large = 100.0;
  ...
  static double screenWidthTenth = screenWidth / 20;

  /*Image Dimensions*/

  static double defaultIconSize = 80.0;
  static double defaultImageHeight = 160.0;
  static double ImageHeight = 140.0;
  ...
  static EdgeInsets spacingAllLarge = EdgeInsets.all(sizeXL);
  static EdgeInsets spacingSmall = EdgeInsets.all(sizeExtraSmall);

  static double settingIconSize = 20.0;
  static double serviceIconSize = 30.0;
  ...
  static void setDefaultSize(context) {
    ...
    spacingSmall = EdgeInsets.all(sizeExtraSmall);
  ...
  static void setScreenAwareConstant(context) {
    ...
    defaultImageHeight = ScreenUtil.instance.setHeight(160.0);
    ImageHeight = ScreenUtil.instance.setHeight(140.0);
